...
VertexCoordinates Model_3DViewer::FromStringToDouble(
    std::vector<std::string> numbers_vector, int& error) {
...
std::vector<int> Model_3DViewer::FromStringToInt(
    std::vector<std::string> numbers_vector, int& error) {
...
size_t Model_3DViewer::GetCountFace() { return CountFace_; }

size_t Model_3DViewer::GetCountVertex() { return CountVertex_; }
...
void Model_3DViewer::SetScaleDefault() {
  double diff = 0;
  double diffArray[] = {ExtremeValues.maxX_ - ExtremeValues.minX_,
                        ExtremeValues.maxY_ - ExtremeValues.minY_,
                        ExtremeValues.maxZ_ - ExtremeValues.minZ_};
  for (int i = 0; i < 3; i++) {
...
void Model_3DViewer::setAxis(Move* o) { Axis_ = o; }

void MoveX::moveModel(double shift, std::vector<VertexCoordinates>& VertexArray,
...
void MoveY::moveModel(double shift, std::vector<VertexCoordinates>& VertexArray,
                      MaxMinValues& ExtremeValues) {
  for (size_t i = 0; i < VertexArray.size(); i++) {
...
void MoveZ::moveModel(double shift, std::vector<VertexCoordinates>& VertexArray,
                      MaxMinValues& ExtremeValues) {
  for (size_t i = 0; i < VertexArray.size(); i++) {
